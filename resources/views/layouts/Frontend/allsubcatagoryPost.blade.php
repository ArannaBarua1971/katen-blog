...
@section('FrontendContent')
    ...
    <div class="container-xl">
        <div class="text-center">
            <h1 class="mt-0 mb-2">{{ ($sepecificPost->first()->subcatagory->subcatagory_name) }}</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="category.html#">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{ ($sepecificPost->first()->subcatagory->subcatagory_name) }}</li>
                </ol>
            </nav>
        </div>
    </div>
